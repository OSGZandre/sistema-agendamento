    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 flex flex-col items-center justify-between">
      ...
      <main className="flex-1 flex items-center justify-center w-full h-full relative">
        ...
        <div className="relative z-10 text-center space-y-6 px-4 py-12 max-w-5xl mx-auto">
          <h2 className="text-5xl font-extrabold text-white border-slate-950 ">
            Tem Vaga?
          </h2>
          <p className="text-xl text-white border-slate-950 max-w-prose mx-auto font-bold">
            Gerencie seus serviços, agendamentos, caixa e perfil de forma fácil
            e prática. Comece agora a transformar sua rotina!
          </p>
          <button
            onClick={handleGetStarted}
            className="bg-cyan-600 font-bold text-black px-8 py-3 rounded-lg hover:bg-cyan-500 transition duration-300 transform hover:scale-105"
          >
            Começar Agora
          </button>
        </div>
