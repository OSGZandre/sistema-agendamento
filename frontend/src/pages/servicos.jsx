...
export default function Servicos() {
  ...
  return (
      <div className="min-h-screen bg-gray-100 flex flex-col">
        <header className="bg-trasnparent text-black border-b-2 border-[#3E57B3] p-4">
          <div className="max-w-5xl mx-auto flex justify-between items-center">
            ...
            <button
                ...
                className="bg-trasnparent text-black px-4 py-2 rounded-xl border-2 border-[#3E57B3] hover:bg-[#A7B4E3]"
            >
              Voltar
            </button>
          </div>
        ...
        <main className="max-w-8xl mx-auto p-6 flex flex-row gap-6 flex-1">
          <div className="w-1/2 bg-white p-6 rounded-xl shadow border-[#3E57B3] border-2">
          ...
          <div className="w-1/2 flex flex-col bg-white rounded-xl border-[#3E57B3] border-2">
                        ...
                        >
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="bg-transparent text-black border-2 border-red-700 px-2 py-1 rounded-xl hover:bg-red-700"
                            >
                              Excluir
                            </button>
                          </div>
